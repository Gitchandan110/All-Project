...
public class SK_CreateAccount extends Base{
	...
	public void CreateAccount() {
		...
		newaccountbl.fillFirstName();
		newaccountbl.fillLastName();
		newaccountbl.fillMobileNumber();
		newaccountbl.fillSafeWord();
		newaccountbl.fillEmail();
		newaccountbl.fillConfirmEmail();
		newaccountbl.fillPassword();
		newaccountbl.fillConfirmPassword();
	    newaccountbl.clickSaveProfile();
